...
//        "https://placehold.co/1920x940", //this._imageService.loadImage1920x940('soccer-field.jpeg'),
      ...
      //  imageDesktop: "https://placehold.co/1920x940",// this._imageService.loadImage1920x940('P1120107.JPG'),
        ...
        message: "<strong>Date:</strong> Tuesday, May 21st, 2024<br>Location: Loch March Golf & Country Club - 1755 Old Carp Rd.<br>Cost: $175 per golfer (includes green fees, golf cart, and buffet supper)<br>Maximum 4 golfers per team",
        link: "/register",
      ...
      },
      {
        ...
        message: "Are you looking for something fun to do on Tuesday, May 21st, 2024? We are looking for help with golf registration, selling Raffle Board tickets, and various other activities. Please join us as a volunteer, and help make our 2024 Charity Golf Tournament the best one yet!",
        link: "/volunteer",
